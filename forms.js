function recomendacao() {
    ...
    if (atvds) {
        ...
        if (atividades === "0") {
            ...
            res.innerHTML += `<p>
            As telas são ferramentas comuns de trabalho. No entanto, apesar da praticidade tecnológica, a exposição excessiva as telas causa preocupações relaciondas a <strong>saúde ocular</strong></p>
        ...
        <ul>
            <li>
            <h4>● Estudar: </h4>
            <p>Explore cursos onlines e materiais educativos.</p>
            </li>
            <li>
            <h4>● Trabalhar: </h4>
            <p>Utilize ferramentas digitais para aumentar sua produtividade e sua carreira profissional</p>
            </li>
            <li>
            <h4>● Aprender algo novo:</h4>
            <p>Descubra hobbies ou habilidades, como programar ou cozinhar</p>
            </li>
            <li>
            <h4>● Estimule sua criatividade:</h4>
            <p>Use aplicativos para expressar sua criatividade, como arte, escrita ou música.</p>
            </li>
        </ul>`;
        }
    } else {
            ...
            res.innerHTML += `<p>Você já utiliza proteção ocular. Caso queira saber mais <a href="https://hopr.com.br/uso-prolongado-de-telas-como-cuidar-da-saude-dos-seus-olhos/.">Acesse Aqui!</a></p>`
                ...
                res.innerHTML += `<p>Cuidado! Utilizar alguma proteção é fundamental para sua saúde ocular.</p>
                                  <ul>
                                        ...
                                        <li>
                                              <h4> Visite um oftalmologista </h4>
                                              <p>É importante para verificar se o uso de óculos é necessário, o que pode trazer conforto para a visão.</p>
                                        </li>
                                  </ul>`
            }   
        } else {
    ...
    if(atrp){
        ...
        if(atrapalha === "0"){
            res.innerHTML += `<p> Se o uso das telas atrapalham na suas atividades diárias, considere seguir as seguintes recomendações:</p>
                <ul>
                    <li>Utilizar aplicativos para controle e estabeleça limites. Exemplo:
                        <ul>
                             ...
                             <li>
                                <strong> - Stay Focused: </strong> Bloqueia app ou sites que consomem muito tempo.
                             </li>   
                        </ul>
                    </li>
                    <li>
                       - Estabeleça zonas livres de celular;
                    </li>
                    <li>
                       - Desative as notificações;
                    </li>
                    <li>
                       - Pare de utilizar as telas 1 hora antes de dormir e evite elas logo após acordar.
                    </li>
                </ul>`
        } else if(atrapalha === "1"){
    ...
    res.innerHTML += `<p><strong>LEMBRE-SE!</strong> O que importa não é necessariamente a <span>quantidade</span> de tempo em que você passa em frente as telas, mas sim a <span>qualidade</span> de como você utiliza elas. Foque sempre na qualidade do tempo de tela! </p>`
}
